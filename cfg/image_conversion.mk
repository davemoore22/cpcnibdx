...
# Mode 1 Black, Yellow, Orange, Red
#PALETTELL={0 24 15 6}
#PALETTELR={0 24 15 6}
#PALETTELD={0 26 15 6}
#PALETTELM={0 26 15 6}
#PALETTEOL={0 26 4 6}
#PALETTEOR={0 26 4 6}
#PALETTETEXT={0 26 4 6}
PALETTESPRITES={0 18 11 6}
#PALETTEICONS={0 13 26 6}
#PALETTEHUD={0 26 15 6}
#$(eval $(call IMG2SPRITES,img/hud.png,1,img,116,32,$(PALETTEHUD),mask,redist/,))
#$(eval $(call IMG2SPRITES,img/logo.png,1,img,156,76,$(PALETTELL),mask,src/,))
#$(eval $(call IMG2SPRITES,img/text.png,1,textdata,8,8,$(PALETTETEXT),tileset,src/))
#$(eval $(call IMG2SPRITES,img/sprites.png,1,sprite,8,8,$(PALETTESPRITES),tileset,tileset/))
#$(eval $(call IMG2SPRITES,img/icons.png,1,icons,16,16,$(PALETTEICONS),tileset,src/))
############################################################################
